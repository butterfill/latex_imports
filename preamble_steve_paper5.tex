...
\providecommand{\ititle}{}
\providecommand{\isubtitle}{}
\providecommand{\iauthor}{}
\providecommand{\iemail}{}

\title{\ititle\\\isubtitle}
\newcommand{\paper@ifblankTF}[3]{\if\relax\detokenize{#1}\relax #2\else #3\fi}
\newcommand{\paperauthorblock}{%
  \paper@ifblankTF{\iauthor}{}{\iauthor}%
  \paper@ifblankTF{\iemail}{}{%
    \paper@ifblankTF{\iauthor}{}{\\}%
    <{\iemail}>%
  }%
}
...
\geometry{
  twoside=false,
  headsep=2em, %keep running header away from text
  footskip=1cm, %keep page numbers away from text
  top=3cm, %increase to 3.5 if use header
  left=4cm, %increase to 3.5 if use header
  right=4cm, %increase to 3.5 if use header
  textheight=22cm
}
